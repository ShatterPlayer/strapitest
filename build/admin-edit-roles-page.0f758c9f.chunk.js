(self.webpackChunkstrapitest=self.webpackChunkstrapitest||[]).push([[2544],{98374:(U,L,o)=>{"use strict";o.d(L,{F:()=>O});var e=o(67294),h=o(51435),P=o(86896),v=o(88767);const O=(T={},R={})=>{const{id:E="",...S}=T,{get:V}=(0,h.kY)(),{locale:a}=(0,P.Z)(),Z=(0,h.Xe)(a,{sensitivity:"base"}),{data:m,error:M,isError:F,isLoading:g,refetch:b}=(0,v.useQuery)(["roles",E,S],async()=>{const{data:Q}=await V(`/admin/roles/${E??""}`,{params:S});return Q},R);return{roles:e.useMemo(()=>{let Q=[];return m&&(Array.isArray(m.data)?Q=m.data:Q=[m.data]),[...Q].sort((oe,ee)=>Z.compare(oe.name,ee.name))},[m,Z]),error:M,isError:F,isLoading:g,refetch:b}}},24233:(U,L,o)=>{"use strict";o.d(L,{V:()=>P});var e=o(51435),h=o(88767);const P=(v={id:null},O={})=>{const{id:T,...R}=v,{get:E}=(0,e.kY)(),{data:S,error:V,isError:a,isLoading:Z,refetch:m}=(0,h.useQuery)(["roles",T,"permissions",R],async()=>{const{data:{data:M}}=await E(`/admin/roles/${T}/permissions`,{params:R});return M},O);return{permissions:S,error:V,isError:a,isLoading:Z,refetch:m}}},25545:(U,L,o)=>{"use strict";o.r(L),o.d(L,{CreatePage:()=>me,default:()=>Ae});var e=o(67294),h=o(40720),P=o(90731),v=o(96987),O=o(12473),T=o(34726),R=o(16607),E=o(10574),S=o(31988),V=o(6498),a=o(38670),Z=o(457),m=o(51435),M=o(97695),F=o(66115),g=o(41054),b=o(41609),z=o.n(b),Q=o(86896),oe=o(86706),ee=o(16550),C=o(88972),de=o(36364),J=o(30909),te=o(90065),Y=o(24233),ue=o(87561);const Le=ue.Ry().shape({name:ue.Z_().required(m.I0.required),description:ue.Z_().required(m.I0.required)}),ce=C.ZP.div`
...
`,Z=({children:m,disabled:M=!1,error:F,expanded:g=!1,hasErrorMessage:b=!0,id:z,onToggle:Q,toggle:oe,size:ee="M",variant:C="primary",shadow:de})=>{const J=(0,O.M)(z),te=h.useMemo(()=>({expanded:g,onToggle:Q,toggle:oe,id:J,size:ee,variant:C,disabled:M}),[M,g,J,Q,ee,oe,C]);return(0,e.jsxs)(v.S.Provider,{value:te,children:[(0,e.jsx)(a,{"data-strapi-expanded":g,disabled:M,"aria-disabled":M,expanded:g,hasRadius:!0,variant:C,error:F,shadow:de,children:m}),F&&b&&(0,e.jsx)(E.x,{paddingTop:1,children:(0,e.jsx)(T.Z,{variant:"pi",textColor:"danger600",children:F})})]})}},68889:(U,L,o)=>{"use strict";o.d(L,{v:()=>v});var e=o(85893),h=o(31254),P=o(16607);const v=({children:O,...T})=>{const{expanded:R,id:E}=(0,h.A)();if(!R)return null;const S=`accordion-content-${E}`,V=`accordion-label-${E}`,a=`accordion-desc-${E}`;return(0,e.jsx)(P.x,{role:"region",id:S,"aria-labelledby":V,"aria-describedby":a,...T,children:O})}},31254:(U,L,o)=>{"use strict";o.d(L,{A:()=>P,S:()=>h});var e=o(67294);const h=(0,e.createContext)({disabled:!1,expanded:!1,id:"",size:"M",variant:"primary"}),P=()=>(0,e.useContext)(h)},1744:(U,L,o)=>{"use strict";o.d(L,{B:()=>m});var e=o(85893),h=o(58471),P=o(88972),v=o(63122),O=o(31254);const T=({expanded:M,disabled:F,variant:g})=>{let b="neutral100";return M?b="primary100":F?b="neutral150":g==="primary"&&(b="neutral0"),b};var R=o(58753),E=o(85200),S=o(96987),V=o(10574);const a=(0,P.ZP)(R.A)`
  text-align: left;
